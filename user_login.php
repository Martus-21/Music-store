...
?>
    ...
    <div class="container" >
        ...
        <div class="col-md-15">
            <div class="row">
                ...
                while ($product = mysqli_fetch_assoc($featured)) :  ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <button id="<?= $product['id']; ?>" type="button" class="btn btn-success" data-toggle="modal" data-target="#details-<?= $product['id']; ?>">Details</button>
                    </div>
                <?php
            ...
            <?php include 'details-modal-fender.php';
